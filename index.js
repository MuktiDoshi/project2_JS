...
const loadInitialCardData = () => {
  ...
  //loop over those array of task object to create HTML card, inject into DOM
    ...
    const taskData = {
        ...
        const deleteCard = (event) => {
         ...
         const targetID = event.target.id;
          ...
          //match the id of the element with the id inside he global store
